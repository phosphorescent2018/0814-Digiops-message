...
const NODE_GROUPS: NodeGroup[] = [
    {
        title: '进入',
        nodes: [{ label: '客户群组', color: '#00c893', icon: Users }],
    },
    {
        title: '动作',
        nodes: [
            { label: '结束节点', color: '#cbd0db', shape: 'circle', text: 'END' },
            { label: '延时器', color: '#fa8c16', shape: 'circle', icon: ClockIcon },
            { label: 'A/B测试', color: '#13c2c2', icon: GitBranch },
            { label: '判断', color: '#7a5ad6', shape: 'diamond', icon: Diamond },
            { label: '动作判断', color: '#7a5ad6', shape: 'diamond', icon: MousePointerClick },
            { label: '群组过滤', color: '#7a5ad6', shape: 'diamond', icon: Filter },
        ],
    },
    {
        title: '渠道',
        nodes: [
            { label: '短信', color: '#2f54eb', icon: MessageSquareText },
            { label: 'WhatsApp', color: '#52c41a', icon: MessageCircle },
            { label: '智能语音', color: '#1677ff', icon: AudioLines },
            { label: 'Viber', color: '#597ef7', icon: Phone },
            { label: 'Webhook', color: '#13c2c2', icon: Webhook },
            { label: '切片', color: '#fa8c16', icon: Slice },
            { label: '应用推送', color: '#1677ff', icon: Bell },
            { label: '电销', color: '#2f54eb', icon: PhoneCall },
            { label: '优惠券', color: '#fa541c', icon: Ticket },
        ],
    },
];
